...
if ~isvector(q) or length(q) ~= 7
    ...
    link_0_b = link_0_b*makehgtform('zrotate', q[0])
    link_1_0 = link_1_0*makehgtform('zrotate', q[1])
    link_2_1 = link_2_1*makehgtform('zrotate', q[2])
    link_3_2 = link_3_2*makehgtform('zrotate', q[3])
    link_4_3 = link_4_3*makehgtform('zrotate', q[4])
    link_5_4 = link_5_4*makehgtform('zrotate', q[5])
    link_6_5 = link_6_5*makehgtform('zrotate', q[6])
